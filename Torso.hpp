...
public:
    //constructor
    Torso(string n, int p_num, PartType t, double w, double c, string d, int bc) : battery_compartments(bc), head(Head("",-1,t,-1,-1,"")), locomotor(Locomotor("",-1,t,-1,-1,"",-1)), Part(n,p_num,t,w,c,d) { }
    //setters
