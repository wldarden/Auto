...
Controller.o: Controller.cpp Controller.hpp View.o Shop.o Robot.o Associate.o Customer.o PartType.hpp Order.o globals.hpp Date.hpp Status.hpp
	$(CXX) $(CXXFLAGS) -c controller.cpp
View.o: View.cpp View.hpp globals.hpp std_lib_facilities.h Shop.hpp
	$(CXX) $(CXXFLAGS) -c View.cpp
Shop.o: Shop.cpp Shop.hpp std_lib_facilities.h Robot.hpp Customer.hpp Associate.hpp Part.hpp Order.hpp PartType.hpp
...
Part.o: Part.cpp Part.hpp std_lib_facilities.h PartType.hpp  
	$(CXX) $(CXXFLAGS) -c Part.cpp
Arm.o: Arm.cpp Arm.hpp Part.hpp PartType.hpp
	$(CXX) $(CXXFLAGS) -c Arm.cpp
Battery.o: Battery.cpp Battery.hpp Part.hpp PartType.hpp
	$(CXX) $(CXXFLAGS) -c Battery.cpp
Head.o: Head.cpp Head.hpp Part.hpp PartType.hpp
	$(CXX) $(CXXFLAGS) -c Head.cpp
Locomotor.o: Locomotor.cpp Locomotor.hpp Part.hpp PartType.hpp
	$(CXX) $(CXXFLAGS) -c Locomotor.cpp
Torso.o: Torso.cpp Torso.hpp Part.hpp Arm.hpp Battery.hpp Head.hpp Locomotor.hpp PartType.hpp
